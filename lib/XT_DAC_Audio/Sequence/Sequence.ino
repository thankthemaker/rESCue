// Demo's how to play multiple sounds one after the other easily with teh Sequence Class
// whether those sounds are WAVs or Music Score's or a mixture, 
// here we demo a mixture, a wav followed by a music score.
...
void setup() {
  ...
  DacAudio.Play(&Sequence);                 // Play the sequence, will play just the once and then stop
                                            // See MultiPlayRepeat for a never ending version
}
